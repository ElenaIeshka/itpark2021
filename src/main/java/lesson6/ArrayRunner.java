...
public class ArrayRunner {
    public static void main(String[] args) {
        ...
        int[] intArray = new int[10];//0
        boolean[] booleans = new boolean[10]; //folse
        String[] str = new String[3];//null (массив ссылочного типа)
...
//        }
    ...
    public static String[] weekDays() {
        ...
        return (random.nextBoolean()) ? new String[] {"m","g","h"}: new String[]{} ;
    }
