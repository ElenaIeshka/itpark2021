...
public class ReflectionRunner {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Конструктор класса :" + carClass.getName()+ Arrays.toString (constructors));
        ...
        System.out.println("Ширина авто: " + declaredFields[2].getDouble(skodaFabia));

        Method getMarkAndModelsMethod = carClass.getDeclaredMethod("getMarkAndModel", int.class);
        getMarkAndModelsMethod.setAccessible(true);
        String markAndModel = (String) getMarkAndModelsMethod.invoke(skodaFabia, 1);
